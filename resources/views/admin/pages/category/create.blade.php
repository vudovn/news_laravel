    ...
    <div class="row mb-8">
        <div class="col-md-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                ...
                <div>
                    <a href="{{ route('admin.user.create') }}" class="btn btn-primary"><i class="bi bi-plus"></i>Thêm danh
                        mục</a>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow border-0">
                <div class="card-body d-flex flex-column gap-8 p-7">
                    ...
                    <div class="d-flex flex-column gap-4">
                        ...
                        <form action="{{ route('admin.category.store') }}" method="POST" class="row g-3 needs-validation"
                            novalidate="">
                            @csrf
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <select name="parent_id" id="parent_id" class="form-select @error('parent_id') is-invalid @enderror">
                                    ...
                                    @php
                                    function showCategory($categories, $parent_id = NULL, $char = '')
                                    {
                                        foreach ($categories as $key => $value_vip) {
                                            if ($value_vip->parent_id == $parent_id) {
                                                echo "<option value='$value_vip->id'>$char $value_vip->name</option>";
                                                unset($categories[$key]);
                                                showCategory($categories, $value_vip->id, $char . '|-- ');
                                            }
                                        }
                                    }
